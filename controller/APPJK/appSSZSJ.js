                    ...
                    if (fields.shuju != "") {
                        ...
                        (function iterator(j) {
                            ...
                            var userModeulesJson = {
                                "StudyID":fields.StudyID,
                                "Subjects.persons.id":data[j].id
                            }
                            if (fields.shuju == "点击上传图片") {
                                userModeulesJson.imageType = 0;
                            }else if (fields.shuju == "等待核查") {
                                userModeulesJson.imageType = 1
                            }else if (fields.shuju == "正在核查") {
                                userModeulesJson.imageType = 2
                            }else if (fields.shuju == "质疑处理中" ) {
                                userModeulesJson.imageType = 6
                            }else if (fields.shuju == "冻结") {
                                userModeulesJson.imageType = 3
                            }
                            userModeules.find(userModeulesJson,function (err, userModeulesData) {
                                if (userModeulesData.length > 0) {
                                    shujuData.push(data[j])
                                }else if (fields.shuju == "点击上传图片"){
                                    shujuData.push(data[j])
                                }
                                iterator(j+1);
                            })
